...
public class Log4jChanges extends org.apache.log4j.HTMLLayout {
    //private static final Logger log = Logger.getLogger(Log4jChanges.class);
    ...
    public String format(LoggingEvent event) {
        ...
        sbuf.append(Layout.LINE_SEP + "<tr align=center>" + Layout.LINE_SEP);
        
        sbuf.append("<td >");
        
        sbuf.append(dateHelper.getSystemDate("dd/mmm/yyyy"));
        sbuf.append("</td>" + Layout.LINE_SEP);
        
        String escapedThread = Transform.escapeTags(event.getThreadName());
        sbuf.append("<td title=\"" + escapedThread + " thread\">");
        
        sbuf.append(dateHelper.getSystemTime());
        
        sbuf.append("</td>" + Layout.LINE_SEP);
        
        sbuf.append("<td >");
        //sbuf.append(dateHelper.getBrowserVersion());
        sbuf.append("CHROME");
        ...
        if (event.getLevel().equals(Level.DEBUG)) {
            ...
            sbuf.append("<td bgcolor=\"#F40404\" title=\"Level\">");
        ...
        sbuf.append("<td align=left title=\"Message\">");
    ...
    public String getHeader() {
        ...
        sbuf.append("th {background: #000000; color: #FFFFFF; text-align: center;}" + Layout.LINE_SEP);
        sbuf.append("-->" + Layout.LINE_SEP);
        ...
        sbuf.append("<table cellspacing=\"0\" cellpadding=\"4\" border=\"1\" bordercolor=\"#224466\" width=\"100%\">"
                + Layout.LINE_SEP);
        sbuf.append("<tr>" + Layout.LINE_SEP);
        sbuf.append("<th>Date(MM/DD/YY) </th>" + Layout.LINE_SEP + Layout.LINE_SEP);
        sbuf.append(Layout.LINE_SEP);
        sbuf.append("<th>Time</th>" + Layout.LINE_SEP);
        sbuf.append("<th>BrowserName/Version</th>" + Layout.LINE_SEP);
        sbuf.append("<th>Logger Type</th>" + Layout.LINE_SEP);
        sbuf.append("<th>ClassName</th>" + Layout.LINE_SEP);
        if (locationInfo) {
