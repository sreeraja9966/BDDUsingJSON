...
public class LoadAllFiles extends TestBase {
...
LoadAllFiles n=new LoadAllFiles();
n.convertToMap(xpathLocatorMap);
System.out.println(xpathLocatorMap.get("CommonModeOfTransactionScreen_transferTransactionAmt"));
