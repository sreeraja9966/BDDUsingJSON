@RemittanceIssueWithDenom
Feature: Remittance Instrument Issue Functionality

@RemittanceIssueWithDenom @setUp 
...
Examples:
|parentReport|
|Remittance Instrument Issue With Denom|

####################################################################### Remittance Instrument Issue Entry ########################################################################################


Scenario Outline: 2.Remittance Instrument Issue Entry With Cash Payment Mode with Denom Y
Scenario : 2.Remittance Instrument Issue Entry With Cash Payment Mode with Denom Y
...
Then verify REMIT_INSTRUMENT Table Remittance_AMT "<Amount>" Pay_Mode "<PaymentMode>"  where voucher_num "<StoreInCache>" and ORIG_RESP "<ORIG_RESP>"  and tranType "<tranType>" and remittanceType "<RemittanceType>" and beneficiaryName "<BeneficiaryName>" and accNo "<accNo>" Denom Y
...
Scenario : 5.Remittance Instrument Issue Cash Receipt Entry
Given user opens a testCase "<testCase>"
...
|testCase|StoreInCache|TotalTransactionAmount|2000FromDenom|500FromDenom|200FromDenom|100FromDenom|50FromDenom|20FromDenom|10FromDenom|1FromDenom|PaiseFromDenom|2000ToDenom|500ToDenom|200ToDenom|100ToDenom|50ToDenom|20ToDenom|10ToDenom|1ToDenom|PaiseToDenom|successMessage|DenomRateUiXpath|bankcode|userId|tranType|DenomY_N|
|PO Cash Receipt Entry|POCashIssue|1017.15|0|2|0|0|0|0|0|17|15|0|0|0|0|0|0|0|0|0|Denomination Entered Successfully. |//div[@id='userwiseDenominationModel']|101|555|D|Y|
|DD Cash Receipt Entry|DDCashIssue|2017.15|1|0|0|0|0|0|0|17|15|0|0|0|0|0|0|0|0|0|Denomination Entered Successfully. |//div[@id='userwiseDenominationModel']|101|555|D|Y|
|PO Cash Receipt Entry for Rejection|POCashIssueReject|2017.15|1|0|0|0|0|0|0|17|15|0|0|0|0|0|0|0|0|0|Denomination Entered Successfully. |//div[@id='userwiseDenominationModel']|101|555|D|Y|
|DD Cash Receipt Entry for Rejection|DDCashIssueReject|1017.15|0|2|0|0|0|0|0|17|15|0|0|0|0|0|0|0|0|0|Denomination Entered Successfully. |//div[@id='userwiseDenominationModel']|101|555|D|Y|
...
Then store number on model with name "<StoreInCache>" and "<KeyInCache>"
Then user finds successMessage "<successMessage>"
Then verify Transaction_Header table TRANS_AMT "<Amount>"  where voucher_num "<StoreInCache>" and tranType "<tranType>" with DenomY
Then verify Transaction_Details Table TRANS_AMT "<Amount>" accNo "<accNo>"  where voucher_num "<StoreInCache>" and tranType "<tranType>" and Remittance Commition "<RemittanceCommition>" and CGST "<CGST>" and SGST "<SGST>" and AddingChargesAmount "<AddingChargesAmount>"
...
|Remittance Amount Greater Than Available Balance|Remittance Instrument Issue|Menu_RemittanceInstrumentIssueEntry|PO - Pay Order|Transfer|400000|Ganesh|101210101010000100|Remittance amount exceeds available balance.|
...
|Future Cheque Not Allowed|Remittance Instrument Issue|Menu_RemittanceInstrumentIssueEntry|PO - Pay Order|Transfer|2000|101210101100000404|Payment not allowed for future cheque.|27/02/2020|1|//span[@id='instrumentNumberremittanceInstrumentIssue_ExceptionMsg']|
...
Examples:
|testCase|MenuName|MenuPath|RemittanceType|PaymentMode|Amount|accNo|ValidationMessage|InstrumentDateUi|InstrumentNumber|xpath|
|Already Paid Cheque|Remittance Instrument Issue|Menu_RemittanceInstrumentIssueEntry|PO - Pay Order|Transfer|2000|101210101100000404|Cheque is already paid.|23/02/2020|3|//span[@id='instrumentNumberremittanceInstrumentIssue_ExceptionMsg']|
...
Scenario Outline: 12.Remittance Instrument Issue Entry Cash Receipt Rejection
