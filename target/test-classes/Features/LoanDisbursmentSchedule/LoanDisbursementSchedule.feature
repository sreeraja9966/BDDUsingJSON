...
@DisbSchedule
Scenario Outline: 7.Loan Disbursement Schedule Entry Authorization
Scenario : 7.Loan Disbursement Schedule Entry Authorization
Given user opens a testCase "<testCase>"
Given User is on "<MenuName>" "<MenuPath>"screen
...
Scenario Outline: 8.Loan Disbursement Schedule Entry Rejection
Scenario : 8.Loan Disbursement Schedule Entry Rejection
Given user opens a testCase "<testCase>"
Given User is on "<MenuName>" "<MenuPath>"screen
And user select Account Number "<accNo>" on Loan Disbursement Schedule Auth Screen
Then user verify Sanctioned Amount "<SanctionedAmount>" and DisbursedAmount "<DisbursedAmount>"
...
@DisbSchedule
Scenario Outline: 2.Loan Disbursement Schedule Modification Entry
Scenario : 2.Loan Disbursement Schedule Entry
Given user opens a testCase "<testCase>"
Given User is on "<MenuName>" "<MenuPath>"screen
And user enters accNo "<accNo>" 
...
Scenario Outline: 7.Loan Disbursement Schedule Modification Authorization
Scenario : 7.Loan Disbursement Schedule Modification Authorization
Given user opens a testCase "<testCase>"
Given User is on "<MenuName>" "<MenuPath>"screen
And user select Account Number "<accNo>" on Loan Disbursement Schedule Auth Screen
...
@DisbSchedule
Scenario Outline: 7.Loan Disbursement Schedule Modification Rejection
Scenario : 7.Loan Disbursement Schedule Modification Rejection
Given user opens a testCase "<testCase>"
Given User is on "<MenuName>" "<MenuPath>"screen
And user select Account Number "<accNo>" on Loan Disbursement Schedule Auth Screen
Then user verify Sanctioned Amount "<SanctionedAmount>" and DisbursedAmount "<DisbursedAmount>" on mod auth screen
...
@DisbSchedule @setUp
Scenario Outline: 9.Loan Disbursement Schedule Auth Screen Tearup
