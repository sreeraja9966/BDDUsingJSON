...
@Table(name = "REPAYMENT_SCHEDULE_TEMP")
public class RepaymentScheduleTempEntity implements Serializable {
    
    private static final long serialVersionUID = 8726032818379951908L;
    
    public RepaymentScheduleTempEntity() {
        super();
    }
    
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "repayment_temp_gen")
    @SequenceGenerator(name = "repayment_temp_gen", sequenceName = "REPAYMENT_SCHEDULE_TEMP_SEQ", allocationSize = 1)
