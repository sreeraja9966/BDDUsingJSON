...
public class EmailHelper extends TestBase {
    ...
    public void sendReport(String recipients, String reportName, String attachmentName) {
        ...
        try {
            ...
            String sharedLocation="\\\\sysnik-D036\\Reports";
            messageBodyPart.setText("Please find the Automation Test Report on the following Shared Location. "+sharedLocation);
